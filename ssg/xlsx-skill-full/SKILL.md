---
name: xlsx-skill-full
description: Manipulate Excel (.xlsx) spreadsheets with Python (openpyxl/pandas). Use for any SpreadsheetBench-style task that reads an input .xlsx, edits cells/ranges/formulas, and writes an output workbook. Covers workflow, library choice, matching/target-range hygiene, and robustness for fill/formula/lookup tasks.
---
